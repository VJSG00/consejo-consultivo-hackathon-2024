...
interface PaginatedTableEntregaProps {
  items: Entrega[];
  columns: { key: string; label: string }[];
  searchKeys: string[];
}

const PaginatedTableDonantes: React.FC<PaginatedTableEntregaProps> = ({ items, columns, searchKeys }: PaginatedTableEntregaProps) => {
  const {
    query,
    setQuery,
    currentPage,
